 ...
 * CN779        | Max EIRP - 2
 * EU433        | Max EIRP - 2
 * EU868        | Max EIRP - 2          这是最大功率减2的意思，如 16 - 2 = 14
 * IN865        | Max EIRP - 2
 * KR920        | Max EIRP - 2
 * US915        | Max ERP - 2
 * RU864        | Max EIRP - 2
...
/*!
 * LoRaWAN Frame counter identifier.    lorawan帧计数器标识符
 */
...
/*!
 * LoRaMac Key identifier           loramac密钥标识符
 */
...
typedef enum eAddressIdentifier
{
    ...
    MULTICAST_3_ADDR = 3,
    /*!
     * Unicast End-device address   单播节点标识符
     */
    UNICAST_DEV_ADDR = 4,
}AddressIdentifier_t;
